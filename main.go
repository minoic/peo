...
func main() {
	...
	beego.Router("/admin-console/close-work-orderform", &controllers.AdminConsoleController{}, "post:CloseWorkOrder")
	...
	beego.Router("/new-orderform", &controllers.OrderCreateController{})
	beego.Router("/new-pack", &controllers.NewPackController{})
	beego.Router("/orderform/:orderID", &controllers.OrderInfoController{})
	beego.Router("/orderform/:orderID/pay-by-balance", &controllers.OrderInfoController{}, "get:PayByBalance")
	...
	beego.Router("/user-work-orderform", &controllers.UserWorkOrderController{})
	beego.Router("/user-work-orderform/post", &controllers.UserWorkOrderController{}, "post:NewWorkOrder")
